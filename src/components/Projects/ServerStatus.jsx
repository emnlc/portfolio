      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-[26px] w-20 border border-black/20 dark:border-white/20 animate-pulse"
            />
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {data.servers.map((server) => (
          <div
            ...
            className="flex items-center gap-1.5 px-2 py-1 border border-black/20 dark:border-white/20 text-xs font-light text-black dark:text-white"
          >
            <div
